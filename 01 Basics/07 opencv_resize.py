...
# let's resize out image to 150 pixels wide, but in order to
# prevent out resizes image from being skewed/distorted, we must
...
# function which will *automatically* maintain out aspect ratio
# for us
