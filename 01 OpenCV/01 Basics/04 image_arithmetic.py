...
ap.add_argument("-i", "--image", type=str, default="01 OpenCV/01 Basics/Images/opencv_logo.png",
...
# will result in a module ("wrap around") instead of being clipped
# to the range [0, 255]
...
# load the original input image and display it to out screen
...
# dimensions* as out input image, filling it with ones, multiplying
